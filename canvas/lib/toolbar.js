      ...
      (() => {
	    ...
	    $('body').append(`<div class="custom-modal-container">
              <div class="custom-modal-content">
                <div class="button-download" id="svg">Descricao do servico</div>
                <div class="button-download" id="png" href="mailto:contato@thepointcopiadora.com.br">Baixar Imagem e encaminhar email</div>
              </div>
            </div>`)
          } else if (id === 'clear') {
